# DIA 4 · Dijous 6 d'agost de 2026
...
* Navegar pel Danubi.
* Descobrir un poble amb molt d'encant.
* Passejar sense presses.
* Menjar bé.
* Tornar a Budapest a mitja tarda.

No és un dia per veure moltes coses.

És un dia per gaudir.
...
## Bitllets del vaixell

Et recomano comprar-los **abans del viatge**.
...
Si continua el patró dels darrers estius, intentaria agafar un vaixell entre les **09:00 i les 09:30**. Així arribaràs a Szentendre amb tot el matí per davant i evitaràs les hores de més calor.
...
No és un ferri ràpid.

És un passeig pel Danubi.

Veureu:

* petites platges,
* boscos,
* cases al costat del riu,
* petits ports,
* molta vegetació.

Seu a la coberta superior.
...
No té res d'espectacular.

Simplement és molt agradable.
...
Perfecta per descansar una estona.
...
Si prefereixes art contemporani, també pots visitar alguna de les petites galeries del centre.

---

## Botigues

Les millors compres són:
...
Evitaria els imants i records típics.
...
No depens dels horaris dels vaixells.
...
És molt més relaxada.

La llum de la tarda sobre el Danubi és preciosa.

Però els horaris són molt més limitats i el trajecte és més llarg.

Jo només l'escolliria si no tens pressa per arribar a Budapest.
...
aquesta és probablement la millor nit.
...
No hi ha tanta gent com durant el dia.
...
| ----------- | ------------------------------ |
| 08:00       | Sortida hotel                  |
| 08:20       | Moll Vigadó tér                |
| 09:00       | Vaixell                        |
| 11:00       | Szentendre                     |
| 11:00-15:30 | Passeig, cafè, museu, botigues |
| 15:30       | Tornada (HÉV o vaixell)        |
| 17:30       | Hotel                          |
| 20:00       | Sopar                          |
| 21:30       | Passeig Andrássy út            |

---

## Les 4 coses imprescindibles de Szentendre

Si només hagués de triar quatre experiències, serien aquestes:

1. **Perdre't pels carrers del casc antic**, sense seguir un itinerari estricte.
2. **Passejar per la riba del Danubi** i seure una estona en alguna terrassa.
